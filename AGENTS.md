...
- Stage 44: script destructors with engine-queued, exactly-once finalization.

The next planned language feature is inheritance/polymorphism, followed by
access control, casts, operator
